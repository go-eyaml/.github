...
<p align="center"><strong>eyaml encryption in pure Go — PKCS7 encrypt/decrypt for hiera-eyaml data, stdlib crypto only.</strong></p>
...
- **Pure Go, zero cgo.** `CGO_ENABLED=0`; imports the Go standard library's crypto packages only. Cross-compiles to the
